...
describe('migrations', () => {
  ...
  describe('runMigrations', () => {
    ...
    it('parses db_version correctly', async () => {
      ...
      mockQueryOne.mockResolvedValue({ value: '12' })
    ...
    it('runs many statements for full migration', async () => {
      ...
      // v1 = 1 call, v2-v12 = 2 calls each (migration + version update) = 1 + 11*2 = 23
      expect(mockExecSQL.mock.calls.length).toEqual(23)
    })
