...
const EXPECTED_TRIGGERS = [
  ...
  { schema: 'workspace', name: 'trg_goal_insert' },
  { schema: 'workspace', name: 'trg_goal_update' },
  { schema: 'workspace', name: 'trg_goal_note_insert' },
  { schema: 'workspace', name: 'trg_goal_note_update' },
  { schema: 'workspace', name: 'trg_goal_note_delete' },
