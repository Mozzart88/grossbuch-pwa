...
const mockExpenseTags = [
    { id: 12, name: 'food', created_at: 1, updated_at: 1 },
    { id: 13, name: 'transport', created_at: 1, updated_at: 1 },
]
...
describe('BudgetsPage', () => {
    beforeEach(() => {
        ...
        mockCurrencyRepository.findDefault.mockResolvedValue(mockCurrency)
    })
