...
describe('TransferTransactionForm', () => {
  ...
  it('allows changing datetime', () => {
    function Wrapper() {
      ...
      return <TransferTransactionForm {...defaultProps} datetime={datetime} onDateTimeChange={setDatetime} />
    }
    render(<Wrapper />)
  ...
  it('calls update instead of create when initialData present', async () => {
    ...
    render(<TransferTransactionForm {...defaultProps} initialData={initialData} datetime={initialData.timestamp * 1000} />)
    ...
    fireEvent.change(document.getElementById('amount')!, { target: { value: '55' } })
