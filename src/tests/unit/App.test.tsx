...
vi.mock('../../pages', () => ({
  ...
  GoalsPage: () => <div data-testid="goals-page">Goals</div>,
  GoalDetailsPage: () => <div data-testid="goal-details-page">Goal Details</div>,
  GoalTransactionsPage: () => <div data-testid="goal-transactions-page">Goal Transactions</div>,
  GoalPutTakePage: () => <div data-testid="goal-put-take-page">Goal Put/Take</div>,
